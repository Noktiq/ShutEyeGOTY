...
public class ThirdPersonMovement : MonoBehaviour
{
    ...
    public killPlatformerEnemy script6;
     public killPlatformerEnemy script7;
      public killPlatformerEnemy script8;
       public killPlatformerEnemy script9;
  ...
  [SerializeField] private Transform pos4;
   ...
   private int checkpointCount = 1;
    ...
    //  }
        ...
        if(script.enemyKilled == true || script2.enemyKilled == true || script3.enemyKilled == true || script4.enemyKilled == true || script5.enemyKilled == true || script6.enemyKilled == true || script7.enemyKilled == true || script8.enemyKilled == true || script9.enemyKilled == true)
        {
            velocity.y = Mathf.Sqrt(jumpHeight * -2 * gravity);
